  ...
  return (
    <DrawerRoot {...props} direction="bottom" onOpenChange={handleOpenChange} container={document.body}>
      ...
      <DrawerPortal>
        ...
        <DrawerContent className="fixed inset-x-1 bottom-0 z-50 flex justify-center group max-w-5xl mx-auto">
          <div className="pointer-events-auto relative w-full backdrop-blur-xs  origin-bottom animate-hud-unfold-in group-data-[state=closed]:animate-hud-unfold-out">
            ...
            <div className="absolute -top-8 left-3.5 flex flex-col items-center">
              <div className="h-2 w-2 rounded-full bg-cyan-400 shadow-[0_0_8px_rgba(56,189,248,0.9)]" />
              <div className="h-6 w-px bg-cyan-400/60" />
            </div>
            ...
            {/* Title bar */}
            {title && (
              <svg className="pointer-events-none absolute top-0 left-0 h-20 w-96 overflow-visible">
                <path
            ...
            >
              ...
              <div className="absolute top-0 left-1/2 h-[3px] w-12 -translate-x-1/2 bg-cyan-300/80 shadow-[0_0_8px_rgba(56,189,248,0.9)] rounded-full hud-inner-pulse" />
              {children}
            </div>
            ...
            <div className="absolute left-10 bottom-6 h-1 w-[15%] bg-cyan-400/20 overflow-hidden">
              <div className="w-1/3 h-full bg-cyan-400/70 animate-[slide_3s_linear_infinite]" />
            </div>

            <div className="absolute left-10 bottom-4 h-1 w-[25%] bg-cyan-400/20 overflow-hidden">
              <div className="w-1/3 h-full bg-cyan-400/70 animate-[slide_2s_linear_infinite]" />
            </div>
