...
import { ClippedButton, ClippedCard, HudDrawer, IconButton } from '@/components/ui';
  ...
  return (
    <>
      <ClippedCard className="w-full md:w-1/2 font-mono" accents={['bottom-right']}>
        <div className="flex flex-row flex-wrap items-center gap-4 pb-2 md:pb-4 border-b border-primary-soft">
          <IconButton
          ...
          <div className="flex flex-row gap-4">
            <ClippedButton
              clipSize="sm"
              className={cn('rotate', sort === 'speed-asc' && 'rotate-180')}
              variant="simple"
        ...
        <div className=" h-[500px] overflow-y-auto flex flex-col py-4 gap-4">
