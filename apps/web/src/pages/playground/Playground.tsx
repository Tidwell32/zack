...
export const Playground = () => {
  return (
    <ClippedCard className="mt-4 w-full" borderColor={COLORS.secondary} variant="segmented" accents={['top-right']}>
      <div className="h-full w-full">
        ...
        <div className="flex flex-col gap-4 mt-4">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-4">
            <ClippedCard borderWidth={2} clipSize="lg" className="flex-1 max-w-64">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-4">
            <ClippedCard borderWidth={2} clipSize="lg" className="flex-1 max-w-64">
              <div className="flex flex-col h-full">
                ...
                <Typography variant="monoStat" className="mb-4">
                  Here I log my workouts to track and visualize my progress.
                </Typography>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <ClippedCard borderWidth={2} clipSize="lg" className="flex-1 max-w-64">
              <div className="flex flex-col h-full">
                ...
                <Typography variant="monoStat" className="mb-4">
                  Mostly just me keeping track of my swing progression and distances.
                </Typography>
            ...
            <ClippedCard borderWidth={2} clipSize="lg" className="flex-1 max-w-64">
              <div className="flex flex-col h-full">
                ...
                <Typography variant="monoStat" className="mb-4">
                  My favorite recipes and maybe some notes and pictures.
                </Typography>
